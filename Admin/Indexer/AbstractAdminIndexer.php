...
abstract class AbstractAdminIndexer
{
    ...
    /**
     * @description use for \Contena\Elasticsearch\Admin\AdminSearcher::search for the global api/es-search endpoint
     */
    ...
    /**
     * @description use for \Contena\Elasticsearch\Admin\AdminSearcher::searchIds for api/{entity}/search-ids endpoint
     */
