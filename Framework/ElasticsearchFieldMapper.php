...
class ElasticsearchFieldMapper
{
     ...
     *
     * This method is typically used in the context of blog definitions, where each item represents a database record to be indexed in Elasticsearch.
     *
     ...
     *
     * This method is commonly used to handle associations, such as blog names and descriptions in different languages.
     *
    ...
    private function formatCustomField(string $entity, array $customFields, Context $context): array
    {
        ...
        foreach ($customFields as $name => $customField) {
             ...
             * See https://github.com/contena/contena/issues/4459
             */
